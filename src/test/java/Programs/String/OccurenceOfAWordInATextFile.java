...
public class OccurenceOfAWordInATextFile {

	public static void main(String[] args) throws FileNotFoundException {
		
		//Reading the word to be found from the user
	      Scanner sc1 = new Scanner(System.in);					//Entering the word to search
	      System.out.println("Enter the word to be found");
	      String word = sc1.next();								//Storing the entered word in "word" variable
	      boolean flag = false;									//Assuming the word is not present if flag is false
	      int count = 0;
